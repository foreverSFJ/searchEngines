...
import searchEngines.storage.AbstractThreadCrawl;

public class BxwxNovelThread extends AbstractThreadCrawl{

	public BxwxNovelThread() throws FileNotFoundException {
